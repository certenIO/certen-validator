...
func loadEVMChainsFromEnv() map[int64]*EVMChainConfig {
	...
	if rpc := getEnv("ARBITRUM_SEPOLIA_RPC_URL", ""); rpc != "" {
		chains[421614] = &EVMChainConfig{
			...
			MaxConnections:     10,
			MaxIdleConnections: 5,
			AnchorV4Address:    getEnv("ARBITRUM_SEPOLIA_ANCHORV6_ADDRESS", getEnv("ARBITRUM_SEPOLIA_ANCHORV5_ADDRESS", getEnv("ARBITRUM_SEPOLIA_ANCHORV4_ADDRESS", "0xD2f19FfF59d9eADA39cf5a3737914Aa1F6B4ca12"))),
