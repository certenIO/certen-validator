...
func loadEVMChainsFromEnv() map[int64]*EVMChainConfig {
	...
	if rpc := getEnv("BASE_SEPOLIA_RPC_URL", ""); rpc != "" {
		chains[84532] = &EVMChainConfig{
			...
			MaxConnections:     10,
			MaxIdleConnections: 5,
			AnchorV4Address:    getEnv("BASE_SEPOLIA_ANCHORV6_ADDRESS", getEnv("BASE_SEPOLIA_ANCHORV5_ADDRESS", getEnv("BASE_SEPOLIA_ANCHORV4_ADDRESS", "0x7a8c5DC01C2d2Ba498F76832dBcbf0Fe2f69a6C3"))),
	...
	if rpc := getEnv("MOONBASE_ALPHA_RPC_URL", ""); rpc != "" {
		chains[1287] = &EVMChainConfig{
			...
			MaxConnections:     10,
			MaxIdleConnections: 5,
			AnchorV4Address:    getEnv("MOONBASE_ALPHA_ANCHORV6_ADDRESS", getEnv("MOONBASE_ALPHA_ANCHORV5_ADDRESS", getEnv("MOONBASE_ALPHA_ANCHORV4_ADDRESS", "0x7a8c5DC01C2d2Ba498F76832dBcbf0Fe2f69a6C3"))),
