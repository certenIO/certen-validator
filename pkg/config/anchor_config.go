...
func loadEVMChainsFromEnv() map[int64]*EVMChainConfig {
	...
	if rpc := getEnv("ARBITRUM_SEPOLIA_RPC_URL", ""); rpc != "" {
		chains[421614] = &EVMChainConfig{
			...
			AnchorV4Address:    getEnv("ARBITRUM_SEPOLIA_ANCHORV6_1_ADDRESS", getEnv("ARBITRUM_SEPOLIA_ANCHORV6_ADDRESS", getEnv("ARBITRUM_SEPOLIA_ANCHORV5_ADDRESS", getEnv("ARBITRUM_SEPOLIA_ANCHORV4_ADDRESS", "0xD2f19FfF59d9eADA39cf5a3737914Aa1F6B4ca12")))),
	...
	if rpc := getEnv("OPTIMISM_SEPOLIA_RPC_URL", ""); rpc != "" {
		chains[11155420] = &EVMChainConfig{
			...
			AnchorV4Address:    getEnv("OPTIMISM_SEPOLIA_ANCHORV6_1_ADDRESS", getEnv("OPTIMISM_SEPOLIA_ANCHORV6_ADDRESS", getEnv("OPTIMISM_SEPOLIA_ANCHORV5_ADDRESS", getEnv("OPTIMISM_SEPOLIA_ANCHORV4_ADDRESS", "0xA8CB329e6867296084f87Bf0bB800E44932feac7")))),
	...
	if rpc := getEnv("BASE_SEPOLIA_RPC_URL", ""); rpc != "" {
		chains[84532] = &EVMChainConfig{
			...
			AnchorV4Address:    getEnv("BASE_SEPOLIA_ANCHORV6_1_ADDRESS", getEnv("BASE_SEPOLIA_ANCHORV6_ADDRESS", getEnv("BASE_SEPOLIA_ANCHORV5_ADDRESS", getEnv("BASE_SEPOLIA_ANCHORV4_ADDRESS", "0x7a8c5DC01C2d2Ba498F76832dBcbf0Fe2f69a6C3")))),
	...
	if rpc := getEnv("MOONBASE_ALPHA_RPC_URL", ""); rpc != "" {
		chains[1287] = &EVMChainConfig{
			...
			AnchorV4Address:    getEnv("MOONBASE_ALPHA_ANCHORV6_1_ADDRESS", getEnv("MOONBASE_ALPHA_ANCHORV6_ADDRESS", getEnv("MOONBASE_ALPHA_ANCHORV5_ADDRESS", getEnv("MOONBASE_ALPHA_ANCHORV4_ADDRESS", "0x7a8c5DC01C2d2Ba498F76832dBcbf0Fe2f69a6C3")))),
