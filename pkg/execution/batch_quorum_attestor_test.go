...
func TestSubmitBatchQuorumProof_RefusesNilAggregate(t *testing.T) {
	...
	_, _, err := s.SubmitBatchQuorumProof(context.Background(), 1, [32]byte{}, [32]byte{}, [32]byte{}, nil, [32]byte{})
	if err == nil {
...
func TestSubmitBatchQuorumProof_RefusesZeroSignedPower(t *testing.T) {
	...
	if _, _, err := s.SubmitBatchQuorumProof(context.Background(), 1, [32]byte{}, [32]byte{}, [32]byte{}, agg, [32]byte{}); err == nil {
...
func TestSubmitBatchQuorumProof_RefusesSingleSignerAggregate(t *testing.T) {
	...
	_, _, err := s.SubmitBatchQuorumProof(context.Background(), 1, [32]byte{}, [32]byte{}, [32]byte{}, agg, [32]byte{})
	if err == nil {
